...
|--------|------|----------|--------------|--------|----------|--------|
| phone-a-gateway (Xiaomi 14T) | **api-gateway prod** :4000 + **api-content-prod** :4004 + **OpenClaw** :18789 (Phase 14) | `phone-a-gateway` | `100.120.187.10` | yes | v24.17.0 | phase 13 content fallback; OpenClaw scripts deployed — runtime after onboard |
...
|--------|------------|-------|----------|-------------|
| phone-a-gateway | Xiaomi 14T / Android 13+ | | | Unrestricted; manual boot after reboot (MIUI); `boot-gateway-phone-a`; Phase 14: `boot-openclaw-phone-a` (after `openclaw onboard`) |
